...
<div class="card-body">
	<form>
		...
		<%if (showRedacCheck) { %><div class="form-check">
		...
		if (showForgotten) { %><button type="submit" class="btn btn-primary js-forgotten">Mot de passe oublié</button> <% } %> <button type="submit" class="btn btn-primary js-submit">Valider</button>
