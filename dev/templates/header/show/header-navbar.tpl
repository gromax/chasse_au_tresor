<nav class="navbar navbar-dark bg-primary navbar-expand-lg">
	<a class="navbar-brand js-home" href="#Home">Chasse au trésor &nbsp; <span class="js-spinner"></span></a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<%} else {%>
		<ul class="navbar-nav ml-auto">
			<li class="nav-item"><a class="nav-link js-edit-me" href="#"><i class="fa fa-user"></i> &nbsp; <%- nom %></a></li>
