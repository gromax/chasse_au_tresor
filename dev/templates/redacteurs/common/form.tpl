<form>
	...
	<div class="form-group">
		<label for="item-username" class="control-label">@ :</label>
		<input class="form-control" id="item-username" name="username" type="text" value="<%- username %>" placeHolder="email / identifiant"/>
	</div>
	<%}%>
